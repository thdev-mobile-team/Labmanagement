...
<body>
	<table style="width:100%" cellpadding="0" cellspacing="0">
		<tbody>
			<tr>
				<td><img src="logo_vfis.png" class="img-responsive" /></td>
				<td style="text-align:center; font-size:13pt; font-family:'Times New Roman'">
					<p style="margin:0;padding:0;">VIETNAM</p>
					<p style="margin:0;padding:0;font-weight:bold;">VIETNAM FINLAND INTERNATIONAL SCHOOL</p>
					<p style="margin:0;padding:0;">HoChiMinh City</p>
				</td>
				<td><img src="logo_vfis.png" class="img-responsive" style="visibility: hidden" /></td>
			</tr>
			<tr>
				<td></td>
